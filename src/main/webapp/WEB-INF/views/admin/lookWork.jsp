			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start active open">
					...
					<ul class="sub-menu	">
						...
						<li class="active"><a href="javascript:;"><i class="icon-bar-chart"></i> 作业信息</a></li>
				...
				<div class="col-md-12">
					<div class="portlet box green">
						<div class="portlet-title" style="vertical-align:middle;position:relative;">
							<div class="caption" style="position:absolute;top:30%;"><i class="fa fa-comments"></i>作业信息总览</div>
							...
							<div class="row">
								<div class="col-md-6 col-sm-12">
									<div id="sample_editable_1_filter" class="dataTables_filter">
										...
										<button class="form-control input-inline" onclick="location.href='admin/lookWork';">显示所有</button>
									</div>
								</div>
							</div>
								...
								<div class="col-md-4 col-sm-5 pull-right">
									<div class="dataTables_paginate paging_bootstrap_full_number">
										<ul class="pagination">
											...
											<li id="pageList"></li>
											<li id="pageURL" style="display:none;" name="cno">admin/lookWork</li>
...
var ajaxForMsg = function (p,r,c) {
    $.ajax({
        url:'/HomeWorkWeb/admin/lookWorkMsg',
        type:'GET',
        async:false,
        traditional : true,
        data:{
...
function dataList(info){  /* 将信息写到列表中  */
	...
	for(var j=0;j<info.length;j++){
		var newNode=$('<tr><td>'+info[j].wno+'</td><td>'+info[j].cno+'</td><td>'+info[j].wname+'</td><td>'+info[j].description+'</td><td>'+info[j].start_time+'</td><td>'+info[j].end_time+'</td><td><a class="edit" href="javascript:;">删除</a></td></tr>');
