			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start active open">
					...
					<ul class="sub-menu">
						...
						<li class="active"><a href="admin/mTeacher"><i class="icon-user-follow"></i>教师管理</a></li>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li><a href="admin/mTeacher"><i class="fa fa-angle-left"></i>返回教师总览</a></li>
				</ul>
			</div>
			<h3 class="page-title">学院信息详情 &nbsp;<small id="companyName"></small></h3>
			<!-- END PAGE HEADER-->
			<!-- 显示所有教师 开始 -->
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-red-sunglo bold">学院教师情况</span>
						<span class="caption-helper">&nbsp;共</span>
						<span id="courseWorkAmount">0</span>
						<span class="caption-helper">名教师</span>
					</div>
				</div>
...
function changePar(){  /* 更改页面原始参数的函数  */
	var id2 = GetPar("company");
	if(id2 != null){
		TheName = id2;
	}
	document.getElementById("companyName").innerHTML = TheName;
}
